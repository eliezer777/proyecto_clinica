...
Public Class conexion
    Dim cadena = "Data Source=omen;Initial Catalog=ClinicaNET;User ID= sa;Password=sa1"
    ...
    Function ConsultaSQL(ByVal StringSQL As String) As DataTable
        ...
        cnn = New SqlConnection("Data Source=omen15;Initial Catalog=ClinicaNet2;User ID= sa;Password=sa1")
        cnn.Open()

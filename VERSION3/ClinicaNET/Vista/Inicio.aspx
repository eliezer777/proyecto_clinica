        ...
        <form id="form1" runat="server">
            ...
            <asp:UpdatePanel ID="update_general" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-sm-5" style="border-color: whitesmoke;">
                                                                            ...
                                                                            <br />
                                                                            <asp:TextBox ID="txt_descripcionP" runat="server" placeholder="" ToolTip="" TextMode="MultiLine" Enabled="false" Width="300" Height="200"></asp:TextBox>
                                                                            <br />
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            ...
                                                                            <div class="collapse" id="agendar_citas">
                                                                                <div class="card card-body">
                                                                                    ...
                                                                                    <asp:TextBox runat="server" ID="fecha_cita" TextMode="DateTimeLocal"></asp:TextBox>
                                                                                    <br />
                                                                                    <asp:DropDownList runat="server" ID="drp_cod_doc" CssClass=" dropdown-item" placeholder="codigo del medico"></asp:DropDownList>
                                                                                    <br />
                                                                                    <asp:Button runat="server" ID="txt_asignarcita" Text="Asigna Cita" Class="btn btn-primary"></asp:Button>
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            ...
                                                                            <div class="collapse" id="Eliminar_cita">
                                                                                <div class="card card-body">
                                                                                    <asp:TextBox runat="server" ID="TextBox1" placeholder="Codigo de cita"></asp:TextBox>
                                                                                    <br />
                                                                                    <asp:TextBox runat="server" ID="TextBox2" placeholder="Codigo del doctor"></asp:TextBox>
                                                                                    <br />
                                                                                    <asp:TextBox runat="server" ID="TextBox3" TextMode="DateTimeLocal"></asp:TextBox>
                                                                                    <br />
                                                                                    <asp:Button runat="server" ID="Button1" CssClass="btn btn-danger" Text="Eliminar" />
                                                                                            ...
                                                                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                                                                                <ContentTemplate>
                                                                                                    ...
                                                                                                    <asp:GridView
                                                                                                        ...
                                                                                                        <AlternatingRowStyle CssClass="odd" />
                                                                                                        <Columns>
                                                                                                            <asp:BoundField HeaderText="Codigo de cita" DataField="id_producto" />
                                                                                                            <asp:BoundField HeaderText="Nombre Producto" DataField="Nombre" />
                                                                                                            <asp:BoundField HeaderText="Descripcion" DataField="Descripcion" />
                                                                                                            <asp:BoundField HeaderText="Fecha de ingreso" DataField="fecha_ingreso" />
                                                                                                            <asp:BoundField HeaderText="Fecha de vencimiento" DataField="fecha_vencimiento" />
                    ...
                    <asp:HiddenField ID="TabName" ClientIDMode="Static" Value="Datos" runat="server"></asp:HiddenField>
                </ContentTemplate>
            </asp:UpdatePanel>
...
<script type="text/javascript">
    function setNameTab(idTab) {
        var aux = document.getElementById('<%=TabName.ClientID %>');
        aux.value = idTab;
        console.log("set name", idTab)
    }

    //setTabName
    function setTab() {
        console.log("ejecutar tab")
        $(function () {
            var tabName = $("[id*=TabName]").val() != "" ? $(
                "[id*=TabName]").val() : "Datos";
            console.log("hola", tabName);
            $('#' + tabName).tab('show');
            $('#enc' + tabName).addClass('active');
        });
    }
